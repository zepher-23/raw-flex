    ...
    const [formData, setFormData] = useState({
      ...
      return (
        <div className="max-w-md mx-3 lg:mx-6 mt-28 my-10 p-8 bg-gray-100 bg-opacity-20 shadow-md">
         <h4 className="text-3xl font-bold text-white text-center mb-6">Discover the perfect diet and exercise plan to reach your peak fitness!</h4>
          ...
          <div className="mb-4">
            <label className="block text-lg mb-2 text-left px-2">Injuries/Limitations </label>
            <input
              type="text"
              name="injury"
          ...
          <div className="mb-4">
            <label className="block text-lg mb-2 text-left px-2">Diet Preference </label>
            <input
              type="text"
              name="injury"
              ...
              onChange={handleChange}
              className="w-full px-3 py-2 border-b-2  outline-none focus:outline-none rounded-lg bg-transparent"
              placeholder="What is your diet preference?"
            />
          </div>
          <div className="mb-4">
            <label className="block text-lg mb-2 text-left px-2">Allergies </label>
            <input
              type="text"
              name="injury"
          ...
          <div className="mb-4">
  <label className="block text-lg mb-2 text-left px-2">Current Activity Level</label>
  <select
    name="curActivity"
    ...
    className="w-full px-3 py-2 border-b-2 outline-none focus:outline-none rounded-lg bg-transparent"
  >
    <option className="text-primary text-sm" value="" disabled>Select your activity level</option>
    <option className="text-black" value="Sedentary (little or no exercise)">Sedentary (little or no exercise)</option>
    <option className="text-black" value="Lightly active (light exercise/sports 1-3 days/week)">Lightly active (light exercise/sports 1-3 days/week)</option>
    <option className="text-black" value="Moderately active (moderate exercise/sports 3-5 days/week)">Moderately active (moderate exercise/sports 3-5 days/week)</option>
    <option className="text-black" value="Very active (hard exercise/sports 6-7 days a week)">Very active (hard exercise/sports 6-7 days a week)</option>
    <option className="text-black" value="Super active (very hard exercise/physical job & exercise 2x/day)">Super active (very hard exercise/physical job & exercise 2x/day)</option>
  </select>
</div>
